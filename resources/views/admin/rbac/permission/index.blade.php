...
<div class="am-tabs am-margin" data-am-tabs>
    <ul class="am-nav am-nav-tabs">
        ...
        <li class="am-active"><a href="{{ route('admin.rbac.permission.index') }}">权限</a></li>
    </ul>
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a class="am-btn am-btn-default am-btn-xs am-text-primary" href="{{ route('admin.rbac.permission.edit',['id'=>$permission->id]) }}"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-permission-delete" data-href="{{ route('admin.rbac.permission.destroy',['id'=>$permission->id]) }}"><span class="am-icon-trash-o"></span> 删除</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
...
<script type="text/javascript">
    $(".am-permission-delete").click(function () {
